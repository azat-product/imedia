...
<div class="i-formpage__catselect__popup__sublist_desktop hidden-phone">
    <div class="f-msearch__categories__title">
        <div class="pull-left">
            ...
            <div class="subcat">
                <a href="javascript:void(0);" class="backto block j-back" data="{prev:<?= $parent['pid'] ?>}">&laquo; <?= ( $parent['main'] ? _t('item-form','Вернуться к основным категориям') : _t('item-form','Вернуться назад') ) ?></a>
