        ...
        <ul class="breadcrumb j-breadcrumbs-full" vocab="http://schema.org/" typeof="BreadcrumbList">
            ...
            <?php foreach($crumbs as $v):
                if ($v['active']):
                    ...
                    ?><li property="itemListElement" typeof="ListItem"><a href="<?= $v['link'] ?>" title="<?= (!empty($v['link_title']) ? $v['link_title'] : $v[$title_key]) ?>" property="item" typeof="WebPage"><span property="name"><?= $v[$title_key] ?></span></a><meta itemprop="position" content="<?= $i++; ?>" /> <span class="divider">/</span></li><?php
                endif;
            endforeach; ?>
        </ul>
    </div>
