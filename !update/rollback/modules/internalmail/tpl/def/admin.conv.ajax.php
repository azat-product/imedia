...
<tr>
    ...
    <td style="padding-right: 20px; vertical-align:top;" class="<? if(!$v['my']){ ?>from<? } ?><?= $v['blocked']? ' disabled':'' ?>">
        ...
        <a class="j-message-block ajax small desc <?= $v['blocked']? 'j-is-blocked':'' ?>" href="#" data-id="<?= $v['id'] ?>"><?= HTML::escape( (!$v['blocked'] ? _t('internalmail', 'заблокировать') : _t('internalmail', 'разблокировать')), 'js'); ?></a>
        <br />
        <?= $v['message'] ?>
