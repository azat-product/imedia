...
<tr>
    ...
    <td class="row2">
        ...
        <div id="ms-test-settings" class="relative" style="display:none;">
            ...
            <div class="desc left"><?= _t('sendmail', 'например:'); ?> <a class="ajax desc ms-receivers-test-example" href="#">test@gmail.com</a>, <a class="ajax desc ms-receivers-test-example" href="#">123@yandex.ru</a></div>
