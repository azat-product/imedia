...
{
    return htmlspecialchars(bff::locale()->translate($context, $message, $params, $language, $opts), ENT_QUOTES, 'UTF-8');
}

function _tejs($context, $message, array $params = array(), $language = null, array $opts = array())
{
    return strtr(bff::locale()->translate($context, $message, $params, $language, $opts), array(
            '\\' => '\\\\',
            "'"  => "\\'",
            '"'  => '\\"',
            "\r" => '\\r',
